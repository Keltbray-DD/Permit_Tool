  ...
  })(
    {
        ...
        function (r, e, t) {
          ...
          function o(r, e, t) {
            ...
            return (
              y(r, function (r, e) {
                return r
                  ? o.fire("error", { error: r })
                  : (n(o, JSON.parse(e.responseText)), void o.fire("ready"));
              }),
              o
            );
          }
          function i(r, e, t) {
            function n(r, t) {
              return r
                ? o.fire("error", { error: r })
                : (l(t.responseText, e, o), void o.fire("ready"));
            }
            var o = t || L.geoJson();
            return y(r, n), o;
          }
          ...
          function a(r, e, t) {
            function n(r, t) {
              ...
              return r
                ? o.fire("error", { error: r })
                : (o.on("error", n),
                  h(t.responseXML || t.responseText, e, o),
                  o.off("error", n),
                  void (i || o.fire("ready")));
            }
            var o = t || L.geoJson();
          ...
          function s(r, e, t) {
            function n(r, t) {
              ...
              return r
                ? o.fire("error", { error: r })
                : (o.on("error", n),
                  g(t.responseXML || t.responseText, e, o),
                  o.off("error", n),
                  void (i || o.fire("ready")));
            }
            var o = t || L.geoJson();
          ...
          function f(r, e, t) {
            function n(r, t) {
              return r
                ? o.fire("error", { error: r })
                : (v(t.responseText, e, o), void o.fire("ready"));
            }
            var o = t || L.geoJson();
            return y(r, n), o;
          }
          function c(r, e, t) {
            function n(r, t) {
              return r
                ? o.fire("error", { error: r })
                : (d(t.responseText, e, o), void o.fire("ready"));
            }
            var o = t || L.geoJson();
            return y(r, n), o;
          }
          ...
          function p(r, e, t) {
            ...
            return (
              (t = t || L.geoJson()), (e = e || {}), x.csv2geojson(r, e, o), t
            );
          }
          function h(r, e, t) {
            var o = m(r);
          ...
          function d(r, e, t) {
            (t = t || L.geoJson()), (e = e || {});
            for (
              var o = E.decode(r, e.precision),
                i = { type: "LineString", coordinates: [] },
                u = 0;
              u < o.length;
              u++
            )
              i.coordinates[u] = [o[u][1], o[u][0]];
            return n(t, i), t;
          }
          function v(r, e, t) {
            t = t || L.geoJson();
          ...
          function m(r) {
            return "string" == typeof r
              ? new DOMParser().parseFromString(r, "text/xml")
              : r;
          }
          var y = r("corslite"),
            x = r("csv2geojson"),
            ...
            S = r("topojson"),
            T = r("togeojson");
          (e.exports.polyline = c),
            (e.exports.polyline.parse = d),
            (e.exports.geojson = o),
            (e.exports.topojson = i),
            (e.exports.topojson.parse = l),
            (e.exports.csv = u),
            (e.exports.csv.parse = p),
            (e.exports.gpx = a),
            (e.exports.gpx.parse = h),
            (e.exports.kml = s),
            (e.exports.kml.parse = g),
            (e.exports.wkt = f),
            (e.exports.wkt.parse = v);
        },
        {
          corslite: 4,
          csv2geojson: 5,
      ...
      3: [
        function (r, e, t) {
          ...
          function i(r) {
            ...
            if ((l === n || !l) && setTimeout)
              return (l = setTimeout), setTimeout(r, 0);
            try {
              return l(r, 0);
            } catch (e) {
              try {
          ...
          function u(r) {
            ...
            if ((p === o || !p) && clearTimeout)
              return (p = clearTimeout), clearTimeout(r);
            try {
              return p(r);
            } catch (e) {
              try {
        ...
        function (r, e, t) {
          ...
          function n(r, e) {
            ...
            for (var i in r)
              (n = i.match(e)),
                n &&
                  (!t || n[0].length / i.length > o) &&
                  ((o = n[0].length / i.length), (t = i));
            return t;
          }
          function o(r) {
            return n(r, m);
          ...
          function f(r) {
            ...
            return (
              e.forEach(function (e) {
                var n = d.dsvFormat(e).parse(r);
                if (n.length >= 1) {
                  for (var o = s(n[0]), i = 0; i < n.length; i++)
                    if (s(n[i]) !== o) return;
          ...
          function l(r) {
            var e = f(r);
            return e ? c(d.dsvFormat(e).parse(r)) : null;
          }
          function p(r, e, t) {
            ...
            if (
              ("" !== a && (c.crs = { type: "name", properties: { name: a } }),
              "auto" === e.delimiter &&
                "string" == typeof r &&
                ((e.delimiter = f(r)), !e.delimiter))
            )
              return void t({
                type: "Error",
            ...
            var l =
              "string" == typeof r ? d.dsvFormat(e.delimiter).parse(r) : r;
            ...
            if (g) {
              for (p = 0; p < l.length; p++)
                s.push({ type: "Feature", properties: l[p], geometry: null });
              return void t(h.length ? h : null, c);
            }
            for (p = 0; p < l.length; p++)
              if (void 0 !== l[p][u] && void 0 !== l[p][n]) {
                var m,
                  y,
                  x,
                  w = l[p][u],
                ...
                (x = v(w, "EW")),
                  ...
                  isNaN(m) || isNaN(y)
                    ...
                    : (e.includeLatLon || (delete l[p][u], delete l[p][n]),
                      s.push({
                        type: "Feature",
                        properties: l[p],
                        geometry: {
                          type: "Point",
                          coordinates: [parseFloat(m), parseFloat(y)],
                        },
                      }));
              }
            t(h.length ? h : null, c);
          ...
          function h(r) {
            for (
              ...
              t.geometry.coordinates.push(e[n].geometry.coordinates);
            return (
              (t.properties = e.reduce(function (r, e) {
                for (var t in e.properties)
                  r[t] || (r[t] = []), r[t].push(e.properties[t]);
                return r;
              }, {})),
          ...
          function g(r) {
            for (
              ...
              t.geometry.coordinates[0].push(e[n].geometry.coordinates);
            return (
              (t.properties = e.reduce(function (r, e) {
                for (var t in e.properties)
                  r[t] || (r[t] = []), r[t].push(e.properties[t]);
          ...
          !(function (e, o) {
            ...
            function o(r) {
              ...
              function i(r, e) {
                function t() {
                  ...
                  if (34 === r.charCodeAt(t)) {
                    ...
                    return (
                      ...
                      (e = r.charCodeAt(n + 1)),
                      13 === e
                        ? ((o = !0), 10 === r.charCodeAt(n + 2) && ++f)
                        : 10 === e && (o = !0),
                      r.slice(t + 1, n).replace(/""/g, '"')
                    );
                  }
                  for (; f < s; ) {
                    var a = 1;
                    if (((e = r.charCodeAt(f++)), 10 === e)) o = !0;
                    else if (13 === e)
                      (o = !0), 10 === r.charCodeAt(f) && (++f, ++a);
                ...
                for (
                  var n, o, i = {}, u = {}, a = [], s = r.length, f = 0, c = 0;
                  (n = t()) !== u;
      ...
      7: [
        function (r, e, t) {
          ...
          function a(r, e, t) {
            if ((e || (e = "NSEW"), "string" != typeof r))
              return { val: null, regex: t };
            t =
              t ||
              /[\s\,]*([\-|\—|\―]?[0-9.]+)°? *(?:([0-9.]+)['’′‘] *)?(?:([0-9.]+)(?:''|"|”|″) *)?([NSEW])?/gi;
            var n = t.exec(r);
            return n
              ? n[4] && e.indexOf(n[4]) === -1
                ? { val: null, regex: t }
                : {
                    val:
                      ((n[1] ? parseFloat(n[1]) : 0) +
                        (n[2] ? parseFloat(n[2]) / 60 : 0) +
                        (n[3] ? parseFloat(n[3]) / 3600 : 0)) *
                      ((n[4] && "S" === n[4]) || "W" === n[4] ? -1 : 1),
                    regex: t,
                    raw: n[0],
                    dim: n[4],
          ...
          (e.exports = n),
            (e.exports.pair = s),
            (e.exports.format = i),
            (e.exports.formatPair = o),
            (e.exports.coordToDMS = u);
        },
        {},
      ],
      8: [
        function (r, e, t) {
          ...
          function n(r, e) {
            ...
            for (var t = ""; r >= 32; )
              (t += String.fromCharCode((32 | (31 & r)) + 63)), (r >>= 5);
            return (t += String.fromCharCode(r + 63));
          }
          function o(r) {
            for (var e = [], t = 0; t < r.length; t++)
              e.push(r[t].slice().reverse());
            return e;
          }
          var i = {};
          (i.decode = function (r, e) {
            for (
              ...
              (c = null), (s = 0), (f = 0);
              do (c = r.charCodeAt(o++) - 63), (f |= (31 & c) << s), (s += 5);
              while (c >= 32);
              (t = 1 & f ? ~(f >> 1) : f >> 1), (s = f = 0);
              do (c = r.charCodeAt(o++) - 63), (f |= (31 & c) << s), (s += 5);
              while (c >= 32);
            ...
            (i.encode = function (r, e) {
              if (!r.length) return "";
              for (
                var t = Math.pow(10, e || 5),
                  o = n(r[0][0], t) + n(r[0][1], t),
                  i = 1;
                i < r.length;
                i++
              ) {
          ...
          (function (n) {
            var o = (function () {
              ...
              function e(r) {
                ...
                for (var e = 0, t = 0; e < r.length; e++)
                  t = ((t << 5) - t + r.charCodeAt(e)) | 0;
                return t;
              }
              function o(r, e) {
              ...
              function p(r) {
                return f(r.replace(y, "").split(","));
              }
              function h(r) {
                for (
                  var e = r.replace(x, "").split(w), t = [], n = 0;
                  n < e.length;
                  n++
                )
                  t.push(p(e[n]));
              ...
              function g(r) {
                var e,
                  t = [u(r, "lon"), u(r, "lat")],
                  n = a(r, "ele"),
                  o = a(r, "gpxtpx:hr") || a(r, "hr"),
                  i = a(r, "time");
                return (
                  n && ((e = parseFloat(l(n))), isNaN(e) || t.push(e)),
                  {
                    coordinates: t,
                    time: i ? l(i) : null,
              ...
              var L = {
                kml: function (r) {
                  function t(r) {
                    ...
                    return (
                      (r = r || ""),
                      "#" === r.substr(0, 1) && (r = r.substr(1)),
                      (6 !== r.length && 3 !== r.length) || (e = r),
                      8 === r.length &&
                        ((t = parseInt(r.substr(0, 2), 16) / 255),
                        (e = "#" + r.substr(2))),
                      [e, isNaN(t) ? void 0 : t]
                    );
                  }
                  ...
                  function u(r) {
                    ...
                    for (var a = o(r, "when"), s = 0; s < a.length; s++)
                      i.push(l(a[s]));
                    ...
                    for (n = 0; n < y.length; n++)
                      if ((t = o(r, y[n])))
                        for (i = 0; i < t.length; i++)
                          ...
                          else if ("LineString" === y[n])
                            c.push({
                              type: "LineString",
                              coordinates: h(l(a(e, "coordinates"))),
                            });
                          else if ("Polygon" === y[n]) {
                            var d = o(e, "LinearRing"),
                              v = [];
                            for (f = 0; f < d.length; f++)
                              v.push(h(l(a(d[f], "coordinates"))));
                  ...
                  function c(r) {
                    ...
                    if (
                      (f && (u.name = f),
                      "#" !== c[0] && (c = "#" + c),
                      c && m[c] && ((u.styleUrl = c), (u.styleHash = m[c])),
                      p && (u.description = p),
                      h)
                    ) {
                      var y = l(a(h, "begin")),
                    ...
                    if (d) {
                      var w = t(l(a(d, "color"))),
                        L = w[0],
                        E = w[1],
                        S = parseFloat(l(a(d, "width")));
                      L && (u.stroke = L),
                        isNaN(E) || (u["stroke-opacity"] = E),
                        isNaN(S) || (u["stroke-width"] = S);
                    }
                    if (v) {
                      var T = t(l(a(v, "color"))),
                        M = T[0],
                        ...
                        b = l(a(v, "outline"));
                      M && (u.fill = M),
                        isNaN(P) || (u["fill-opacity"] = P),
                        N && (u["fill-opacity"] = "1" === N ? 1 : 0),
                        b && (u["stroke-opacity"] = "1" === b ? 1 : 0);
                    }
                    if (g) {
                      var F = o(g, "Data"),
                        j = o(g, "SimpleData");
                      for (e = 0; e < F.length; e++)
                        u[F[e].getAttribute("name")] = l(a(F[e], "value"));
                      for (e = 0; e < j.length; e++)
                        u[j[e].getAttribute("name")] = l(j[e]);
                    }
                    n.coordTimes.length &&
                      (u.coordTimes =
                        1 === n.coordTimes.length
                          ? n.coordTimes[0]
                          : n.coordTimes);
                    var C = {
                      type: "Feature",
                      geometry:
                        1 === n.geoms.length
                          ? n.geoms[0]
                          : { type: "GeometryCollection", geometries: n.geoms },
                      properties: u,
                    };
                  ...
                  for (
                    ...
                    m["#" + i(w[E], "id")] = e(v(w[E])).toString(16);
                  for (var S = 0; S < L.length; S++)
                    m["#" + i(L[S], "id")] = e(v(L[S])).toString(16);
                  for (var T = 0; T < x.length; T++)
                    g.features = g.features.concat(c(x[T]));
                  return g;
                },
                gpx: function (r) {
                  function e(r, e) {
                    ...
                    for (var s = 0; s < a; s++) {
                      var f = g(t[s]);
                      n.push(f.coordinates),
                        f.time && i.push(f.time),
                        f.heartRate && u.push(f.heartRate);
                    }
                    return { line: n, times: i, heartRates: u };
                  }
                  function t(r) {
                    for (
                      var t, n = o(r, "trkseg"), i = [], a = [], s = [], f = 0;
                      f < n.length;
                      f++
                    )
                      (t = e(n[f], "trkpt")),
                        t.line && i.push(t.line),
                        t.times && t.times.length && a.push(t.times),
                        t.heartRates &&
                          t.heartRates.length &&
                          s.push(t.heartRates);
                    if (0 !== i.length) {
                      var c = u(r);
                      return (
                        a.length && (c.coordTimes = 1 === i.length ? a[0] : a),
                        s.length && (c.heartRates = 1 === i.length ? s[0] : s),
                        {
                          type: "Feature",
                          properties: c,
                          geometry: {
                            type:
                              1 === i.length ? "LineString" : "MultiLineString",
                  ...
                  for (s = 0; s < p.length; s++)
                    (f = t(p[s])), f && m.features.push(f);
                  for (s = 0; s < h.length; s++)
                    (f = n(h[s])), f && m.features.push(f);
        ...
        function (e, t, n) {
          !(function (e, o) {
            ...
            function n(r) {
              ...
              return function (r, e) {
                e || (t = n = 0);
                var s = Math.round((r[0] - u) / o),
                  f = Math.round((r[1] - a) / i);
                (r[0] = s - t), (r[1] = f - n), (t = s), (n = f);
              };
            }
            function o(r, e) {
              for (var t, n = r.length, o = n - e; o < --n; )
                (t = r[o]), (r[o++] = r[n]), (r[n] = t);
            }
            function i(r, e) {
            ...
            function s(r, e) {
              function n(r, e) {
                e.length && e.pop();
                for (
                  var t, n = l[r < 0 ? ~r : r], i = 0, u = n.length;
                  i < u;
                  ++i
                )
                  e.push((t = n[i].slice())), c(t, i);
                r < 0 && o(e, u);
              }
              function i(r) {
              ...
              function f(r) {
                ...
                return "GeometryCollection" === e
                  ? { type: e, geometries: r.geometries.map(f) }
                  : e in p
                  ? { type: e, coordinates: p[e](r) }
                  : null;
              }
              var c = t(r.transform),
                l = r.arcs,
              ...
              return (
                ...
                e.forEach(function (r) {
                  var e,
                    ...
                    s = o[1];
                  if ((e = u[a]))
                    if ((delete u[e.end], e.push(r), (e.end = s), (n = i[s]))) {
                      delete i[n.start];
                  ...
                  else (e = [r]), (i[(e.start = a)] = u[(e.end = s)] = e);
                }),
                n(u, i),
                n(i, u),
                e.forEach(function (r) {
            ...
            function l(r, e, t) {
              ...
              function u(r) {
                "GeometryCollection" === r.type
                  ...
                  : r.type in l && ((s = r), l[r.type](r.arcs));
              }
              var a = [];
              if (arguments.length > 1) {
                var s,
            ...
            function p(r) {
              var e = r[0],
                ...
                n = r[2];
              return Math.abs(
                (e[0] - n[0]) * (t[1] - e[1]) - (e[0] - t[0]) * (n[1] - e[1])
              );
            }
            function h(r) {
              for (var e, t = -1, n = r.length, o = r[n - 1], i = 0; ++t < n; )
                (e = o), (o = r[t]), (i += e[0] * o[1] - e[1] * o[0]);
              return i / 2;
            }
            function g(r) {
            ...
            function d(r, e) {
              ...
              function n(e) {
                return Math.abs(
                  h(s(r, { type: "Polygon", arcs: [e] }).coordinates[0])
                );
              }
              var o = {},
                i = [],
              ...
              return (
                e.forEach(function (r) {
                  "Polygon" === r.type
                    ? t(r.arcs)
                    : "MultiPolygon" === r.type && r.arcs.forEach(t);
                }),
                i.forEach(function (r) {
                  if (!r._) {
                    var e = [],
                      t = [r];
                    for (r._ = 1, u.push(e); (r = t.pop()); )
                      e.push(r),
                        r.forEach(function (r) {
                          r.forEach(function (r) {
                ...
                }),
                {
                  ...
                  arcs: u.map(function (e) {
                    ...
                    if (
                      ...
                      for (var u, a, s = 1, c = n(i[0]); s < t; ++s)
                        (u = n(i[s])) > c &&
                          ((a = i[0]), (i[0] = i[s]), (i[s] = a), (c = u));
                    return i;
                  }),
                }
              );
            ...
            function v(r) {
              ...
              r.forEach(n);
              for (var s in o)
                for (var f = o[s], c = f.length, l = 0; l < c; ++l)
                  for (var p = l + 1; p < c; ++p) {
                    var h,
                      g = f[l],
                      d = f[p];
                    (h = u[g])[(s = i(h, d))] !== d && h.splice(s, 0, d),
                      (h = u[d])[(s = i(h, g))] !== g && h.splice(s, 0, g);
                  }
              return u;
            }
            function m(r, e) {
              ...
              function e(r, e) {
                for (;;) {
                  var t = (e + 1) << 1,
                    ...
                    a = n[u];
                  if (
                    (i < o && m(n[i], a) < 0 && (a = n[(u = i)]),
                    t < o && m(n[t], a) < 0 && (a = n[(u = t)]),
                    u === e)
                  )
                    break;
              ...
              return (
                ...
                r.arcs.forEach(function (r) {
                  ...
                  for (n = 0, s = r.length; n < s; ++n)
                    (f = r[n]), i((r[n] = [f[0], f[1], 1 / 0]), n);
                  for (n = 1, s = r.length - 1; n < s; ++n)
                    (t = r.slice(n - 1, n + 2)),
                      (t[1][2] = e(t)),
                      c.push(t),
                      a.push(t);
                  for (n = 0, s = c.length; n < s; ++n)
                    (t = c[n]), (t.previous = c[n - 1]), (t.next = c[n + 1]);
                  for (; (t = a.pop()); ) {
                    var p = t.previous,
                      h = t.next;
                    t[1][2] < l ? (t[1][2] = l) : (l = t[1][2]),
                      p && ((p.next = h), (p[2] = t[2]), o(p)),
                      h && ((h.previous = p), (h[0] = t[0]), o(h));
                  }
                  r.forEach(u);
                }),
                r
      ...
      11: [
        function (r, e, t) {
          function n(r) {
            ...
            function o() {
              ...
              for (
                ...
                if ("(" === r)
                  i.push(a), (a = []), i[i.length - 1].push(a), t++;
                else if (")" === r) {
                  if (0 === a.length) return null;
                  if (((a = i.pop()), !a)) return null;
                  if ((t--, 0 === t)) break;
                } else if ("," === r) (a = []), i[i.length - 1].push(a);
                else {
                  if (r.split(/\s/g).some(isNaN)) return null;
                  Array.prototype.push.apply(a, r.split(/\s/g).map(parseFloat));
                }
                n();
              }
              return 0 !== t ? null : o;
            ...
            function a() {
              ...
              return r
                ? (n(),
                  e(/^(\))/) ? { type: "Point", coordinates: r[0] } : null)
                : null;
            }
            function s() {
            ...
            function f() {
              ...
              var r = o();
              return r
                ? (n(), { type: "MultiLineString", coordinates: r })
                : null;
            }
            function c() {
          ...
          function o(r) {
            ...
            function n(r) {
              return r.map(t).map(u).join(", ");
            }
            function i(r) {
              return r.map(n).map(u).join(", ");
            }
            function u(r) {
              return "(" + r + ")";
            }
            switch (("Feature" === r.type && (r = r.geometry), r.type)) {
              ...
              case "GeometryCollection":
                return (
                  "GEOMETRYCOLLECTION (" + r.geometries.map(o).join(", ") + ")"
                );
              default:
                throw new Error(
